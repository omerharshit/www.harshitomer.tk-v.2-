...
<div style="text-align: center;" terget="_blank">
 
   <button style="margin-left: 20px; padding-left: 10px; padding-right: 10px; padding-top: 5px; padding-bottom: 5px; font-size: 20px; background-color: black; color:white;" href="/index.html/PHP/reveal.php" terget="_blank">
   <a class="gol" href="/index.html/PHP/reveal.php" terget="_blank" style="color: red;
   font-size: 30px;" > Project Presentaion</a> </button>
    </div>
